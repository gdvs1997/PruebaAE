            ...
            <form method="POST" action="{{ route('productos.store') }}">
                ...
                <div class="row">
                    <div class="input-group col-5">
                        ...
                        <input id="nom_producto" type="text" class="form-control @error('nom_producto') is-invalid @enderror" name="nom_producto" value="{{ old('nom_producto') }}" 
                    ...
                    <div class="input-group col-3">
                        ...
                        <select class="form-control" name="ind_activo" id="ind_activo" required autocomplete="ind_activo" placeholder="Aplica">
